...
class SemiImplicitIncrementParalpha(Helpers):
    ...
    def solve(self):
        ...
        for rolling_interval in range(self.rolling):
            ...
            while not self.stop:       # main iterations
                ...
                res_loc = self.__get_linear_residual_and_prev_F__(v_loc)         # rhs vector of the iteration
                ...
                if self.time_intervals == 1:
                    res_loc = self.__get_w__(self.alphas, v_loc, v_loc) + self.__get_prev_F__()
