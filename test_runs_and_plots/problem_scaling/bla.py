...
petsc_run3 = np.loadtxt('adv1_strong/output/000011/result/result.dat', delimiter='|', usecols=[0, 3], skiprows=3)
print(petsc_run2)
...
plt.grid(True)
plt.legend(['48, 10 reps', '24, 3 reps', '24, 10 reps'])
# plt.xlim([0, 5])
# plt.ylim([0, 15])
plt.show()