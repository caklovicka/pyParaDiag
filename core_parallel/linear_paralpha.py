...
class LinearParalpha(LinearHelpers):
    ...
    def setup(self):
        ...
        assert np.log2(self.time_intervals) - int(np.log2(self.time_intervals)) < 0.1, 'time_intervals = {} should be power of 2.'.format(self.proc_col)
